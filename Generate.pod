...
You can access a member of a parent within C<pre>, C<post>,
or C<assertion> code by naming it,
just as if it was a member of the class.
(You cannot access methods this way.)
You cannot access private members of a parent class from a subclass.
...
For instance, in the following class, the C<$f> of C<$f[0]> is mistaken for
...
You cannot access a method from a parent class in user-defined code
except by referring to it via C<$self>.
