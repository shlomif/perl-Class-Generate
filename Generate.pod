...
If Perl's C<-w> flag is used, the method will C<croak> (see L<Carp>)
if the argument is not a blessed reference
...
If you redefine a class, you silently change the constructor,
