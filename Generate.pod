...
=item %s: Method "%s": A class method cannot be protected or private

(F) In the current implementation, a class method must be public.
...
Copyright (c) 1999, 2000 Steven Wartik.
