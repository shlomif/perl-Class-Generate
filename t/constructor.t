...
Test {
	...
	@members,
	new => { required => 'm1 m2 m3' }
    ];
    All_Members_Required->new( members 1, 2, 3 );
};
eval_invalid_forms 'All_Members_Required', [], [1], [2], [3], [1, 2], [1, 3], [2, 3];

Test {
    class Some_Members_Required => [
	@members,
	new => { required => 'm2 m3' }
    ];
    1;
...
eval_invalid_forms 'Some_Members_Required', [], [1], [2], [3], [1, 2], [1, 3];

Test {
    class Requirement_Is_Expression_Based => [@members, new => { required => 'm1 m2^m3' }];
    1;
};
